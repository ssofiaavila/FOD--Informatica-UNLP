{5. A partir de un siniestro ocurrido se perdieron las actas de nacimiento y 
* fallecimientos de toda la provincia de buenos aires de los últimos diez años. 
* En pos de recuperar dicha información, se deberá procesar 2 archivos por cada 
* una de las 50 delegaciones distribuidas en la provincia, un archivo de nacimientos 
* y otro de fallecimientos y crear el archivo maestro reuniendo dicha información.
Los archivos detalles con nacimientos, contendrán la siguiente información: nro partida
nacimiento, nombre, apellido, dirección detallada (calle,nro, piso, depto, ciudad),
*  matrícula del médico, nombre y apellido de la madre, DNI madre, nombre y apellido 
* del padre, DNI del padre.
En cambio, los 50 archivos de fallecimientos tendrán: nro partida nacimiento, DNI, 
* nombre y apellido del fallecido, matrícula del médico que firma el deceso, fecha y
*  hora del deceso y lugar.
...
apellido, dirección detallada (calle,nro, piso, depto, ciudad), matrícula del médico,
*  nombre y apellido de la madre, DNI madre, nombre y apellido del padre, 
* DNI del padre y si falleció, además matrícula del médico que firma el deceso, 
* fecha y hora del deceso y lugar. Se deberá, además, listar en un archivo de texto
*  la información recolectada de cada persona. 
